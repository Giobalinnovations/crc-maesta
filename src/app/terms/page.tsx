  ...
  return (
    <Section className="py-12">
      ...
      >
        ...
        >
          <p>
            Welcome to CRC Maesta. By accessing our website and using our
        ...
        <motion.div variants={itemVariants} className="space-y-4">
          ...
          <p className="text-muted-foreground">
            ...
            logos, is the property of CRC Maesta and is protected by
        ...
        <motion.div variants={itemVariants} className="space-y-4">
          ...
          <p className="text-muted-foreground">
            CRC Maesta shall not be liable for any indirect, incidental,
